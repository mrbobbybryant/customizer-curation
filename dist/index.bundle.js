...
exports.default = function (input, endpoint, onSelect, onEmpty) {
	...
	[].forEach.call(fields, function (autosuggest) {
		var xhr = false;
...
var _autosuggestList = __webpack_require__(4);

var _autosuggestList2 = _interopRequireDefault(_autosuggestList);

var _autoItem = __webpack_require__(20);
...
document.addEventListener('DOMContentLoaded', function () {
	var autoLists = document.querySelectorAll('.customizer-curation-list');

	if (autoLists) {
		[].forEach().call(autoLists, function (el) {
...
exports.default = function (args) {
	var Hidden = (0, _serializedInput2.default)(args.hidden);
	...
	var List = (0, _list2.default)(args.list, Object.assign(args, { onDrag: drag, onRemove: remove }));

	(0, _autosuggest2.default)(args.input, args.endpoint, function (value, input) {
		List.add(value);
		input.value = '';
		Hidden.add(value);
...
var _serializedInput = __webpack_require__(18);
...
var _dragula = __webpack_require__(6);
...
var registerRemoveEvents = function registerRemoveEvents(list, onRemove) {
	...
	list.addEventListener('click', function (e) {
		var target = e.target.tagName === 'svg' ? e.target : e.target.closest('svg');
...
var crossvent = __webpack_require__(14);
...
var customEvent = __webpack_require__(15);
...
exports.default = function (hiddenEl) {
